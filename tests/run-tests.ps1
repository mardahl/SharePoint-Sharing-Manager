...
foreach ($f in @('15-drawing','20-modals','25-config','30-connections','35-scan-engine','40-revoke','45-targets','50-csv','55-tenant-actions','60-setup-actions','65-views','70-cache','75-key-dispatch')) {
